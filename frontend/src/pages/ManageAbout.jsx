...
// ✅ NEW: Section-specific save buttons
const sectionSaveBtnStyle = { display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#0f172a', color: 'white', padding: '10px 18px', borderRadius: '6px', border: 'none', fontWeight: 'bold', cursor: 'pointer', marginTop: '15px', alignSelf: 'flex-start', fontSize: '13px' };
